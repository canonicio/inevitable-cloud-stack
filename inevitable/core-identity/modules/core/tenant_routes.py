...
from .enhanced_validators import SecureBaseModel, APIParameterValidator
...
from .secure_search import secure_tenant_search
...
class TenantLimits(SecureBaseModel):
...
class DomainCreate(SecureBaseModel):
...
async def list_tenants(
    ...
    if search:
        query = secure_tenant_search(query, search)
