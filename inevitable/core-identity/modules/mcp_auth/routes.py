...
from modules.core.enhanced_validators import APIParameterValidator, SecureBaseModel
...
class MCPPolicyResponse(SecureBaseModel):
    id: int
    tenant_id: str
    name: str
...
class MCPAccessCheck(SecureBaseModel):
    session_token: str
    resource_type: MCPResourceType
    resource_name: str
...
class MCPAccessResponse(SecureBaseModel):
    allowed: bool
...
class MCPAuditLogResponse(SecureBaseModel):
    id: int
    tenant_id: str
    session_id: str
    user_id: int
