...
# Pydantic models
class ConsentUpdateRequest(SecureBaseModel):
    """Request to update consent"""
    purposes: Dict[str, bool]  # purpose -> granted
    context: Optional[Dict[str, Any]] = None


class ConsentStatusResponse(SecureBaseModel):
...
class DataRequestCreateRequest(SecureBaseModel):
    """Create data request"""
...
class ResidencyPolicyRequest(SecureBaseModel):
    """Request for data residency policy"""
    data_types: List[str]


class AnonymizationRequest(SecureBaseModel):
